$(function () {
    ...
    $(window).on('load', function () {
        ...
        $("#common-header").load("../template/common/header.html", function () {
            adjustHeader();
            doSticky();
        });
        ...
        if (DATA_PARAM_IN_URL["lg"] == undefined) {
            PAGE_LANGUAGE = "th";
        } else if (DATA_PARAM_IN_URL["lg"].toLowerCase == "th") {
            PAGE_LANGUAGE = "th";
        } else if (DATA_PARAM_IN_URL["lg"].toLowerCase == "en") {
            PAGE_LANGUAGE = "en";
        } else {
            PAGE_LANGUAGE = "th";
        }
