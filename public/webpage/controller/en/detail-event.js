...
$(function () {
    ...
    $(window).on('load', function () {
        ...
        // window.location.href.split(window.location.hostname + (window.location.port != "" ? ":" + window.location.port : "") + "/")[1].split("/")[0]
        ...
        if (resultList.length <= 0) {
            ...
            for (var i = 0; i < resultList.length; i++) {
                if (!resultList[i].client_image) {
                    document.getElementById("client_comment_image_" + resultList[i].id).setAttribute("style", "display: none")
                    document.getElementById("client_comment_icon_" + resultList[i].id).removeAttribute("style")
                    document.getElementById("client_comment_icon_" + resultList[i].id).setAttribute("style", "font-size: 40px");
